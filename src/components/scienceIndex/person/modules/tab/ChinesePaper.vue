    ...
    <div v-if="!loading">
      <div class="sc-reward" v-for="(item,index) in contentData" :key="index">
        ...
        <div class="sc-div">
          ...
          <Row>
            <i-col span="12" v-if="item.journal !== undefined">
              <label>期刊：</label>
              <span
                class="journal"
                @click="journalSetPath(item.journal.journalName,'/journaldetails',item.journal.journalId)"
